...
class HoroscopeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        dateTVH.text = user.dateBirthday.format(DateTimeFormatter.ofPattern("dd MMMM yyyy")).toString()
    ...
    private fun loadData() {
        ...
        dateBirthday = LocalDate.parse(getSharedPreferences("PREFERENCE", Context.MODE_PRIVATE).getString("BIRTHDAY", null))
        ...
        user = User(dateBirthday, zodiacSign, nameYear, age)
